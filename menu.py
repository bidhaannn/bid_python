...
labtitle=Label(text='Mitho Mitho Menu And Bill ',bg='skyblue',fg='white',font='aeriel 25 bold',padx=500)
labtitle.place(x=1,y=1)

imglogo=PhotoImage(file="D:\python2\logoimage1.png")
...
labfood=Label(frame1,text='Food Items',font='aeriel 15 bold',bg='blue',fg='white',padx=335)
labfood.place(x=0,y=0)


# image 1 or chicken mo:mo
img1=PhotoImage(file='D:\python2\cmomo1.png')
...
img2=PhotoImage(file='D:\\python2\\vmomo1.png')
...
img3=PhotoImage(file='D:\\python2\\buffmomo1.png')
...
img4=PhotoImage(file='D:\python2\paneer momo1.png')
...
img5=PhotoImage(file='D:\python2\chicken pizza1.png')
...
img6=PhotoImage(file='D:\\python2\\veg burger1.png')
...
img7=PhotoImage(file='D:\\python2\\buff sausage1.png')
...
img8=PhotoImage(file='D:\python2\mutton sekuwa1.png')
...
labdrink=Label(frame1,text='Soft drinks',font='aeriel 15 bold',bg='green',fg='white',padx=335)
labdrink.place(x=0,y=400)

# image 9 or cold drinks
img9=PhotoImage(file='D:\python2\cold drinks1.png')
...
# image 10 or lassi
img10=PhotoImage(file='D:\python2\lassi1.png')
...
img11=PhotoImage(file='D:\\python2\\bubble tea1.png')
